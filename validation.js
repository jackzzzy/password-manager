...
//REGEX FOR WEBSITE
const website = /^([a-zA-Z0-9][a-zA-Z0-9-]{1,61}[a-zA-Z0-9]\.)+[a-zA-Z]{2,}$/;
...
//WEBSITE DOMAIN NAME VALIDITY
document.getElementById("website").addEventListener("keyup", (e) => {
  validate(e.target, website);
});
